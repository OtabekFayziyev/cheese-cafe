...
const NAV = [
  ...
  { path:'/admin/orders',      icon:'📋', label:'Buyurtma' },
  { path:'/admin/menu',        icon:'🍽️', label:'Menyu' },
  { path:'/admin/monitoring',  icon:'📈', label:'Monitor' },
  { path:'/admin/customers',   icon:'👥', label:'Mijozlar' },
  { path:'/admin/settings',    icon:'⚙️', label:'Sozlama' },
]
